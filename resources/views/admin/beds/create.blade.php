...
@section('page-title', 'Create New Bed')
        ...
        <form action="{{ route('admin.beds.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="bed_number" id="bed_number" value="{{ old('bed_number') }}" required placeholder="e.g., 101-A" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('bed_number') border-red-500 @enderror">
                    @error('bed_number')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mt-8 flex justify-end space-x-3">
                ...
                <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Create Bed</button>
            </div>
        </form>
    </div>
</div>
